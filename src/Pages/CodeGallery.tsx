...
for (const image of codes) {
  ...
  newCode.style.width = "100%"; // Set the width of the image to 100% of its container
  newCode.style.height = "auto"; // Set the height of the image to auto to maintain aspect ratio
